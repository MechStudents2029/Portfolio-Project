...
export const PROFILE = {
  name: "Adam",
  tagline: "CS + Mechanical Engineering @ NYU Tandon — building AI agents and robots.",
  focus:
    "The engineer who understands growth — a founder-track builder aiming toward a robotics company, currently interning as a fullstack dev, who thinks as much about getting a product in front of real users as about the code underneath it.",
};
...
export const PROJECTS = [
  {
    ...
    details:
      "Worked across three repos (app, API, agent). Shipped an OBS-compatible live caption overlay under deadline, fixed a dual-language caption gating bug and a QR contrast issue, and evaluated Google's gemini-live-translate-livekit architecture for bot-as-subscriber / per-room dispatch patterns. Early traction: 15 businesses onboarded, 500K+ views, 500+ person waitlist.",
